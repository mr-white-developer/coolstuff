...
public class WebReqFilter implements Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
		...
		if (!token.equals("") && token != null) {
			...
			RequestCredential cred = new RequestCredential("", "", true, Utlity.getCurrentDateTime());
			String tokenGust = authen.createToken(cred.getUserId(),cred.getRole(),cred.isGust(),cred.getAccess_datetime());
